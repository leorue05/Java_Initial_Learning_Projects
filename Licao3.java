...
public class Licao3 {
    ...
    public static void main(String args[]) {
        ...
        String nomeSemALetraInicialEFinal =  nome.substring(1,NomeSize-1);
        so.println("trocando a primeira e ultima letra de lugar:\t"+UL+nomeSemALetraInicialEFinal+PL);
        ...
        char SCdoPN1 =  SCdoPN.charAt(0);
        so.println("'"+SCdoPN1+"' e seu valor numerico:\t"+Character.getNumericValue(SCdoPN1));
